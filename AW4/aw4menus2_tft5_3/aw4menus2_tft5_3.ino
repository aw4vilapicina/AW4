...
int sensorTD2 = A2;            // Entrada analogica A2 arduino mega pin0  sensor  TD2
int sensorTD2AW4Value = 0;    // variable to store the value coming from the sensor
int sensorTD3 = A3;          // Entrada analogica A3 arduino mega pin1  sensor  TD3
int sensorTD3Value = 0;      // variable to store the value coming from the sensor
int sensorTD4 = A4;          // Entrada analogica A4 arduino mega pin1  sensor  TD4
int sensorTD4Value = 0;      // variable to store the value coming from the sensor
int sensorTD5 = A5;          // Entrada analogica A5 arduino mega pin1  sensor  TD5
int sensorTD5Value = 0;      // variable to store the value coming from the sensor
...
void foto_presentacion() {
  ...
  myFiles.load(0, 0, 800, 480, "tmb.RAW");
...
#define imagedatatype  unsigned short
  ...
  int CONTADOR, CONTADOR_OFF;
  boolean default_colors = true;
  myGLCD.setColor(VGA_WHITE);

  myGLCD.setBackColor(VGA_BLUE);
  myGLCD.setFont(BigFont);
  myGLCD.print("EV7:", 10, 1);
  myGLCD.print("EV8:", 315, 1);

  myGLCD.printNumI(pwm1_value, 70, 1);
  myGLCD.printNumI(pwm2_value, 375, 1);

  myGLCD.print("I.TD4:", 10, 21);
  myGLCD.print("mA", 169, 21);
  myGLCD.print("I.TD5:", 315, 21);
  myGLCD.print("mA", 474, 21);

  CONTADOR = myButtons.addButton( 600,  200, 60,  30, "CONT");//X, Y , LARGO, ANCHO
  CONTADOR_OFF = myButtons.addButton( 670,  200, 60,  30, "OFF");
  ...
  myGLCD.print("TD1:", 10, 190);
  myGLCD.printNumI(sensorTD1Value, 10, 210);

  myGLCD.print("TD2:", 10, 230);
  myGLCD.printNumI(sensorTD2AW4Value, 10, 250);

  myGLCD.print("TD3:", 10, 270);
  myGLCD.printNumI(sensorTD3Value, 10, 290);


  myGLCD.print("EV1:", 61, 395);
  EV1_ON = myButtons.addButton( 38, 419, 50,  30, "ON");//X, Y , LARGO, ANCHO
  EV1_OFF = myButtons.addButton( 98,  419, 50,  30, "OFF");


  myGLCD.print("EV2:", 183, 395);
  EV2_ON = myButtons.addButton( 160,  419, 50,  30, "ON");
  EV2_OFF = myButtons.addButton( 220,  419, 50,  30, "OFF");


  myGLCD.print("EV3:", 305, 395);
  EV3_ON = myButtons.addButton( 282,  419, 50,  30, "ON");
  EV3_OFF = myButtons.addButton( 342,  419, 50,  30, "OFF");


  myGLCD.print("EV4:", 427, 395);
  EV4_ON = myButtons.addButton( 404,  419, 50,  30, "ON");
  EV4_OFF = myButtons.addButton( 464,  419, 50,  30, "OFF");


  myGLCD.print("EV5:", 549, 395);
  EV5_ON = myButtons.addButton(526,  419, 50,  30, "ON");
  EV5_OFF = myButtons.addButton(586,  419, 50,  30, "OFF");


  myGLCD.print("EV6:", 671, 395);
  EV6_ON = myButtons.addButton(648,  419, 50,  30, "ON");
  EV6_OFF = myButtons.addButton(708,  419, 50,  30, "OFF");
  ...
  myGLCD.fillCircle(94, 465, 15);//X, Y , RADIO
  myGLCD.fillCircle(215, 465, 15);
  myGLCD.fillCircle(337, 465, 15);
  myGLCD.fillCircle(459, 465, 15);
  myGLCD.fillCircle(581, 465, 15);
  myGLCD.fillCircle(703, 465, 15);
  ...
  myGLCD.drawRect(130, 200, 471, 220); //vumetros 1024 /3= 341  80+342 =422
  myGLCD.drawRect(130, 235, 471, 255);
  myGLCD.drawRect(130, 270, 471, 290);
  ...
  while (1)
  {
    ...
    if (myTouch.dataAvailable() == true)
    {
      ...
      if (pressed_button == CONTADOR) {
        myGLCD.print("        ", 600, 240);
        previousMillis = millis();
        touch_click();
      }

      if (pressed_button == CONTADOR_OFF) {
        touch_click();
        prostMillis = millis();
        cuenta = prostMillis - previousMillis;
        myGLCD.printNumI(cuenta, 600, 240);
      }
      ...
      if (pressed_button == EV2_ON) {
        ...
        myGLCD.setColor(VGA_LIME);
        myGLCD.fillCircle(215, 465, 15);//X, Y , RADIO
      ...
      if (pressed_button == EV3_ON) {
        ...
        myGLCD.setColor(VGA_LIME);
        myGLCD.fillCircle(337, 465, 15);//X, Y , RADIO
      ...
      if (pressed_button == EV4_ON) {
        ...
        myGLCD.setColor(VGA_LIME);
        myGLCD.fillCircle(459, 465, 15);//X, Y , RADIO
      ...
      if (pressed_button == EV5_ON) {
        ...
        myGLCD.setColor(VGA_LIME);
        myGLCD.fillCircle(581, 465, 15);//X, Y , RADIO
      ...
      if (pressed_button == EV6_ON) {
        ...
        myGLCD.setColor(VGA_LIME);
        myGLCD.fillCircle(703, 465, 15);//X, Y , RADIO
...
void  lectura_analogica() {
  int valorvumetroTD1, valorvumetroTD2, valorvumetroTD3, valorvumetroTD4, valorvumetroTD5;
  ...
  sensorTD3Value = analogRead(sensorTD3);
  myGLCD.print("    ", 10, 290);
  myGLCD.printNumI(sensorTD3Value, 10, 290);

  sensorTD4Value = analogRead(sensorTD4);
  myGLCD.print("    ", 105, 21);
  myGLCD.printNumI(sensorTD4Value, 105, 21);

  sensorTD5Value = analogRead(sensorTD5);
  myGLCD.print("    ", 410, 21);
  myGLCD.printNumI(sensorTD5Value, 410, 21);

  valorvumetroTD1 = sensorTD1Value / 3 + 130;
  valorvumetroTD2 = sensorTD2AW4Value / 3 + 130;
  valorvumetroTD3 = sensorTD3Value / 3 + 130;

  valorvumetroTD4 = sensorTD4Value / 3 + 130;
  valorvumetroTD5 = sensorTD5Value / 3 + 130;




  myGLCD.setColor(VGA_BLACK);
  myGLCD.fillRect(valorvumetroTD1, 201, 470, 219); //vumetros 1024 /3= 341  80+342 =422
  myGLCD.fillRect(valorvumetroTD2, 236, 470, 254);
  myGLCD.fillRect(valorvumetroTD3, 271, 470, 289);

  myGLCD.setColor(VGA_WHITE);

  myGLCD.fillRect(131, 201, valorvumetroTD1, 219); //vumetros 1024 /3= 341  80+342 =422
  myGLCD.fillRect(131, 236, valorvumetroTD2, 254);
  myGLCD.fillRect(131, 271, valorvumetroTD3, 289);
